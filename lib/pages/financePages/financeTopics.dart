...
final List<Topics> financeTopics = [
  Topics(
    ...
    steps: [],
    video:
        "https://www.youtube.com/watch?v=fle2zwbeVMs&ab_channel=TDAmeritrade",
  ),
  Topics(
  ...
  Topics(
    ...
    steps: [
      "1. Choose how to apply. \n     a. Depending on the institution, you could apply online, by phone or in person. If you apply online, the process will probably take 10 to 20 minutes.",
      "2. Gather your identification. \n     For the application, you will likely need to provide your Social Security number and information from a government-issued ID, such as a driver’s license or passport number.",
      "3. Provide contact details.\n     a.Along with your ID number, expect to enter your contact information, including your first and last name, address — typically, you must be based in the United States — and phone number. You may also be asked for information including your email address and date of birth.",
      "4. Select a single or joint account.\n     a.Let the institution know if you will be opening the account by yourself or with someone else. You’ll need the information from the previous steps for anyone else whose name will be on the account.",
    ...
    video:
        "https://www.youtube.com/watch?v=K6slAUe6aHk&ab_channel=COMMONCENTSMIKE",
  ),
  Topics(
