...
final List<Topics> techTopics = [
  ...
  Topics(
    ...
    video:
        "https://www.youtube.com/watch?v=3Tu1jN65slw&ab_channel=LearnEnglishwithAlex%5BengVid%5D",
  ),
  Topics(
    topicTitle: "Troubleshoot",
    topicColor: Colors.orange,
    topicImage: Image.asset(
      "images/techTroubleshoot.jpg",
      fit: BoxFit.fill,
    ),
    paragraph: "",
    steps: [
  ...
  Topics(
    ...
    steps: [],
    video:
        "https://www.youtube.com/watch?v=S-nHYzK-BVg&ab_channel=TechnologyforTeachersandStudents",
  ),
  Topics(
